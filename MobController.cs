...
public class EnemyController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(theBody.isVisible && PlayerController.instance.gameObject.activeInHierarchy)
        {
            ...
            //RunAway
            if(shouldRunaAway && Vector3.Distance(transform.position, PlayerController.instance.transform.position)  < runAwayRange)
            {
            ...
            //Shoot
            if(shouldShoot && Vector3.Distance(transform.position, PlayerController.instance.transform.position) < shotRange)
            {
